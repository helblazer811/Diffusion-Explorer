/**
 * Pulsing square animation for Divergence Theorem visualization.
 *
 * Creates a traveling pulse animation around the perimeter of a square,
 * representing flux through the boundary.
 */
...
/**
 * Animated pulsing square for visualizing flux through boundary.
 *
