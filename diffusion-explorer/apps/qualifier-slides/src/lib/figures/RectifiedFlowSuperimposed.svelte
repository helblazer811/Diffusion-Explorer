<script lang="ts">
  ...
  import { DoubleFigure, drawScatterPlot, Timeline, createPauseClip, useCanvas2D, PathlineAnimation, type PathlineAnimationState, useVisibilityHandler } from "@diffusion-explorer/ui";
  ...
  async function setupTimeline() {
    ...
    timeline.add(leftPathlineAnimation.clip, { start: 0, end: timing.pauseStart });
