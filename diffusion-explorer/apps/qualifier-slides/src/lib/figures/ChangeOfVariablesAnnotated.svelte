<script lang="ts">
  ...
  import { Figure, drawScatterPlot, drawText, createSourceTargetScales, Timeline, useCanvas2D, PathlineAnimation, type PathlineAnimationState, useVisibilityHandler } from "@diffusion-explorer/ui";
  ...
  export let distributionPointRadius: number = settings.stylingSettings.scatterPlot.radius;
