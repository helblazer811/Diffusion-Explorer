...
// Configuration
const CONFIG = {
  datasetPath: 'static/diffusion_horizontal/data/smiley_face.json',
  modelOutputDir: 'static/diffusion_horizontal/models',
  diffusion: {
...
async function main() {
  ...
  console.log('\n****************************************');
  console.log('  Diffusion Horizontal - Model Training');
  console.log('****************************************\n');
