...
// Configuration
const CONFIG = {
  modelPath: 'static/one_dimensional_flow/models/flow_model.json',
  outputPath: 'static/one_dimensional_flow/cached_samples/trajectories.json',
  dim: 1,
  hidden: 64,
  numSamples: 2000,
  numSteps: 300,
...
async function generateTrajectories(): Promise<void> {
  console.log('\n----------------------------------------');
  console.log('  1D Flow Matching Trajectories');
  console.log('----------------------------------------');
...
async function main() {
  ...
  console.log('\n****************************************');
  console.log('  One-Dimensional Flow - Sample Caching');
  console.log('****************************************\n');
