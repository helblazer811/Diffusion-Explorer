...
// Configuration
const CONFIG = {
  datasetPath: 'static/diffusion_vs_ddim/data/smiley_face.json',
  modelOutputDir: 'static/diffusion_vs_ddim/models',
  diffusion: {
...
async function main() {
  ...
  console.log('\n****************************************');
  console.log('  Diffusion vs DDIM - Model Training');
  console.log('****************************************\n');
  ...
  // Train diffusion model (same model will be sampled with DDPM and DDIM)
